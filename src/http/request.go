...
const (
	SunnyNetRawRequestBody       = "SunnyNetRawRequestBody"
	SunnyNetRawRequestBodyLength = "SunnyNetRawRequestBodyLength"
...
func (r *Request) write(w io.Writer, usingProxy bool, extraHeaders Header, waitForContinue func() bool) (err error) {
	...
	err = tw.writeHeader(r.Header, trace)
	if err != nil {
		return err
	}
...
func readRequest(b *bufio.Reader) (req *Request, err error) {
	...
	if req.URL.Host == "" {
		if req.URL, err = url.ParseRequestURI("http://" + req.Host + rawurl); err != nil {
			return nil, err
		}
	}
	...
	if len(req.Header.GetArray("host")) > 1 {
